...
public class UserController {
	...
	public ResponseEntity<ApiResponse<PreferenceResponseDTO>> registerUser(@RequestBody PreferenceRequestDto preferenceRequestDto) throws ServiceException
	{
		
		ApiResponse<PreferenceResponseDTO> apiResponse = new ApiResponse<>();
	...
	@RequestMapping(method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_VALUE ,path = "/userPreference/{userId}/{preferenceId}")
	...
	public ResponseEntity<ApiResponse<PreferenceResponseDTO>> getPreferenceByID(@PathVariable int preferenceId) throws ServiceException 
	{
		
		ApiResponse<PreferenceResponseDTO> apiResponse = new ApiResponse<>();
		apiResponse.setBody(userService.getPreferenceByIDFromDB(preferenceId));
		apiResponse.setMessage("Preference Object !!");
		apiResponse.setError(false);
		apiResponse.setStatus(HttpStatus.OK);
		return ResponseEntity.status(HttpStatus.OK).body(apiResponse);
	}
